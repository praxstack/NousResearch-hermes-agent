...
def anthropic_prompt_cache_policy(
    ...
    *,
    ...
    # (Parity patch — originally landed in 807a1473d before the policy was
    # extracted to this helper. Kept here so the bedrock toggle still
    # functions after the upstream refactor.)
