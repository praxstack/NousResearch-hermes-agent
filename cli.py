...
class HermesCLI:
    ...
    def run(self):
        ...
        # Prax custom: Kitty-protocol Shift+Enter for Ghostty/Kitty/WezTerm on macOS.
        # Upstream's Windows-only c-j guard above handles Windows Terminal; this
        # provides the Enter-involving newline keystroke on modern macOS terminals
        # without requiring Alt+Enter or stealing plain c-j on Linux consoles.
        try:
            @kb.add('s-enter')
