...
class CLICommandsMixin:
    ...
    def _handle_reasoning_command(self, cmd: str):
        ...
        if len(parts) < 2:
            ...
            # (family-aware), plus the display-state toggles (show/hide/full/clamp).
            _usage_levels = "none|minimal|low|medium|high|xhigh|max"
            try:
                ...
                pass
            _cprint(f"  {_DIM}Usage: /reasoning <{_usage_levels}|show|hide|full|clamp>{_RST}")
            return
